...
import ftc1 from "@/assets/ftc1.jpg";
import ftc2 from "@/assets/ftc2.jpg";
import ftc3 from "@/assets/ftc3.jpg";
...
export default function FTC() {
  ...
  return (
    <main className="bg-white min-h-screen">
      {/* Page Header */}
      <section className="py-12 border-b border-[var(--color-border,#E2E8F0)]">
      ...
      {/* FTC Gallery */}
      <section className="py-14 bg-[var(--color-secondary,#F5F7FA)]">
        <div className="max-w-7xl mx-auto px-6">
