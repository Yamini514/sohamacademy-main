...
const BOT_IMAGES = [
  ...
  { src: bot2, alt: "Our FTC Bot - Build and Testing" },
...
const OUTREACH_DATA = [
  {
    ...
    images: [
      { src: gbhs1, alt: "GBHS, CPL 1" },
      { src: gbhs2, alt: "GBHS, CPL 2" },
      { src: gbhs3, alt: "GBHS, CPL 3" },
      { src: gbhs4, alt: "GBHS, CPL 4" },
    ],
  },
  {
    title: "At ZPHS, Ramanthapur",
    images: [
      { src: zphs1, alt: "ZPHS, Ramanthapur 1" },
      { src: zphs2, alt: "ZPHS, Ramanthapur 2" },
    ],
  },
  {
    title: "At NTT DATA Office",
    images: [
      { src: ntt1, alt: "NTT DATA 2" },
      { src: ntt2, alt: "NTT DATA 3" },
      { src: ntt3, alt: "NTT DATA 1" },
    ],
  },
  {
  ...
  },
  {
    ...
    images: [
      { src: other1, alt: "Schools 1" },
      { src: other2, alt: "Schools 2" },
      { src: other3, alt: "Schools 3" },
      { src: other4, alt: "Schools 4" },
    ],
  },
];
...
function OutreachSection({ title, images, onOpen, startIndex }) {
  ...
  return (
    <div className="rounded-xl p-4 shadow-lg bg-white border border-slate-100">
      {/* IMAGE AREA */}
          ...
          {images.map((_, i) => (
            <span
              ...
              className={`w-2 h-2 rounded-full cursor-pointer transition ${
                i === current ? "bg-sky-500" : "bg-gray-300"
              }`}
            />
          ))}
        </div>
      ...
      {/* TITLE */}
      <h3 className="mt-4 text-center text-slate-900 font-semibold text-base sm:text-lg">
        {title}
      </h3>
    </div>
  );
    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="pt-10 pb-8 md:pt-12 md:pb-10">
        <Container className={FTC_SIDE_PX}>
          <FtcHeading as="h1">First Tech Challenge (FTC) 2024-25</FtcHeading>
          <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div className="space-y-4">
              <FtcText>
                At Soham Academy of Human Excellence, we take pride in nurturing
                young talent through meaningful, hands-on technology education.
                <strong>
                  {" "}
                  Soham Champs 24067, our FIRST Tech Challenge (FTC) robotics
                  team founded in 2023
                </strong>
                , represents our commitment to making high-quality STEM learning
                accessible to students from government schools.
              </FtcText>
              ...
              <FtcText>
                ...
                Indian Championship held in Pune, Maharashtra. Competing against
                elite private institutions and international teams from countries
                such as Kazakhstan and Sri Lanka, Soham Champs emerged as the
                only government school student team at the championship and
                secured the prestigious{" "}
      ...
      <FtcSection eyebrow="MACHINE THAT BROUGHT THE GLORY" title="Our FTC Bot and Practice Hours">
        <FtcText>
          This achievement reinforces our belief that government school students,
          when provided with the right mentorship, exposure, and learning
          environment, can compete and excel on global platforms. At Soham
          Academy, our work goes beyond building robots; we focus on building
          confidence, capability, and character-shaping the next generation of
          engineers, innovators, and changemakers from Telangana.
        </FtcText>
          ...
          <div className="inline-grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {BOT_IMAGES.map((img, i) => (
              <button
                ...
                className="group w-[45vw] max-w-[260px] overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition"
              >
                <img
                  src={img.src}
                  alt={img.alt}
      ...
      >
        <FtcText>
          Students from GBHS, CPL; ZPHS, Nagole; GBHS, CPL Police Lines and Vedic
          Vidyalayam actively participated in every phase of the FTC journey-robot
          design, programming, testing, documentation, outreach, and competition
          preparation-gaining practical exposure to real-world engineering and
          STEM practices with the help of experienced mentors and coaches.
        </FtcText>
      ...
      {/* OUTREACH */}
      <FtcSection
        eyebrow="SHARING KNOWLEDGE AND EXTENDING TECH EDUCATION TO MASSES"
        title="Outreach"
      >
      ...
      {/* HIGHLIGHTS */}
      <FtcSection eyebrow="ABOUT THE BIG DAY" title="FTC 2024-25 Competition Highlights">
        <div className="mt-6 flex justify-center">
          <div className="inline-grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 md:gap-8">
      ...
      {/* SPONSORS */}
      <FtcSection eyebrow="GENEROUS HEARTS WHO MADE IT POSSIBLE" title="Our Sponsors">
        <div className="mt-6 max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8 place-items-center">
