...
export default function Contact() {
  ...
  return (
    <main className="bg-white min-h-screen relative">
      ...
      {alert && (
        <div
          className={`fixed bottom-6 right-6 z-50 px-4 py-3 rounded-lg shadow-md text-white text-sm font-medium transition-all animate-fade-in ${alert.type === "error" ? "bg-rose-600" : "bg-green-600"
            }`}
          role="status"
          aria-live="polite"
        >
